# Runbook — sdkwork-music deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-music-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-music/bundle`, loads the image, starts
